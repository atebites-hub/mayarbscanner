...
from cometbft.p2p import v1 as ____cometbft_p2_p_v1__
from cometbft.types import v1 as ____cometbft_types_v1__
from cometbft.version import v1 as ____cometbft_version_v1__
...
class Block(betterproto.Message):
    ...
    data: "____cometbft_types_v1__.Data" = betterproto.message_field(2)
    evidence: "____cometbft_types_v1__.EvidenceList" = betterproto.message_field(3)
    last_commit: "____cometbft_types_v1__.Commit" = betterproto.message_field(4)
...
class Header(betterproto.Message):
    ...
    version: "____cometbft_version_v1__.Consensus" = betterproto.message_field(1)
    """basic block info"""

    chain_id: str = betterproto.string_field(2)
    height: int = betterproto.int64_field(3)
    time: datetime = betterproto.message_field(4)
    last_block_id: "____cometbft_types_v1__.BlockId" = betterproto.message_field(5)
    """prev block info"""
...
class GetBlockByHeightResponse(betterproto.Message):
    ...
    block_id: "____cometbft_types_v1__.BlockId" = betterproto.message_field(1)
    block: "____cometbft_types_v1__.Block" = betterproto.message_field(2)
...
class GetNodeInfoResponse(betterproto.Message):
    ...
    default_node_info: "____cometbft_p2_p_v1__.DefaultNodeInfo" = (
