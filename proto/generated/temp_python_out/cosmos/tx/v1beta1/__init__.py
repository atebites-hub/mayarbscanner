...
class TxBody(betterproto.Message):
    ...
    unordered: bool = betterproto.bool_field(4)
    """
    ...
    timeout_timestamp: datetime = betterproto.message_field(5)
    """
...
class GetBlockWithTxsResponse(betterproto.Message):
    ...
    block_id: "___cometbft_types_v1__.BlockId" = betterproto.message_field(2)
    block: "___cometbft_types_v1__.Block" = betterproto.message_field(3)
