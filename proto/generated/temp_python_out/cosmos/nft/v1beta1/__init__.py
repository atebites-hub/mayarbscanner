...
class QueryStub(betterproto.ServiceStub):
    ...
    async def nft_class(
        ...
        *,
        ...
        return await self._unary_unary(
            "/cosmos.nft.v1beta1.Query/NFTClass",
            query_class_request,
            QueryClassResponse,
            timeout=timeout,
            deadline=deadline,
...
class QueryBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/cosmos.nft.v1beta1.Query/NFTClass": grpclib.const.Handler(
                self.__rpc_nft_class,
                grpclib.const.Cardinality.UNARY_UNARY,
                QueryClassRequest,
                QueryClassResponse,
            ),
