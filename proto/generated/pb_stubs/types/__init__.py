...
class NodeAccount(betterproto.Message):
    ...
    def __post_init__(self) -> None:
        super().__post_init__()
        if self.is_set("reward"):
            warnings.warn("NodeAccount.reward is deprecated", DeprecationWarning)
...
class BondProvider(betterproto.Message):
    ...
    def __post_init__(self) -> None:
        super().__post_init__()
        if self.is_set("bonded"):
            warnings.warn("BondProvider.bonded is deprecated", DeprecationWarning)
...
class LiquidityProvider(betterproto.Message):
    ...
    def __post_init__(self) -> None:
        super().__post_init__()
        if self.is_set("node_bond_address"):
            warnings.warn(
                "LiquidityProvider.node_bond_address is deprecated", DeprecationWarning
            )
...
class MsgBond(betterproto.Message):
    ...
    asset: "_common__.Asset" = betterproto.message_field(8)
...
class MsgUnBond(betterproto.Message):
    ...
    asset: "_common__.Asset" = betterproto.message_field(9)
...
class EventAffiliateFee(betterproto.Message):
    ...
    asset: "_common__.Asset" = betterproto.message_field(5)
