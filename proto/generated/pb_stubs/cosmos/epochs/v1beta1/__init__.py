...
class EventEpochStart(betterproto.Message):
    ...
    epoch_number: int = betterproto.int64_field(1)
    epoch_start_time: int = betterproto.int64_field(2)
...
@dataclass(eq=False, repr=False)
class QueryEpochInfosRequest(betterproto.Message):
    """
...
@dataclass(eq=False, repr=False)
class QueryEpochInfosResponse(betterproto.Message):
    """
...
class QueryStub(betterproto.ServiceStub):
    async def epoch_infos(
        self,
        query_epoch_infos_request: "QueryEpochInfosRequest",
        *,
...
class QueryBase(ServiceBase):
    ...
    async def epoch_infos(
        self, query_epoch_infos_request: "QueryEpochInfosRequest"
    ) -> "QueryEpochInfosResponse":
    ...
    async def __rpc_epoch_infos(
        self,
        stream: "grpclib.server.Stream[QueryEpochInfosRequest, QueryEpochInfosResponse]",
    ) -> None:
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/cosmos.epochs.v1beta1.Query/EpochInfos": grpclib.const.Handler(
                self.__rpc_epoch_infos,
                grpclib.const.Cardinality.UNARY_UNARY,
                QueryEpochInfosRequest,
                QueryEpochInfosResponse,
            ),
            "/cosmos.epochs.v1beta1.Query/CurrentEpoch": grpclib.const.Handler(
