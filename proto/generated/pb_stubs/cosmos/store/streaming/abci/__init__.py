...
class ListenFinalizeBlockRequest(betterproto.Message):
    ...
    req: "____cometbft_abci_v1__.FinalizeBlockRequest" = betterproto.message_field(1)
    res: "____cometbft_abci_v1__.FinalizeBlockResponse" = betterproto.message_field(2)
...
class ListenCommitRequest(betterproto.Message):
    ...
    res: "____cometbft_abci_v1__.CommitResponse" = betterproto.message_field(2)
