...
from ....cometbft.abci import v1 as ___cometbft_abci_v1__
...
class BlockMetadata(betterproto.Message):
    ...
    response_commit: "___cometbft_abci_v1__.CommitResponse" = betterproto.message_field(
        6
    )
    request_finalize_block: "___cometbft_abci_v1__.FinalizeBlockRequest" = (
        betterproto.message_field(7)
    )
    response_finalize_block: "___cometbft_abci_v1__.FinalizeBlockResponse" = (
