...
from .....cometbft.abci import v1 as ____cometbft_abci_v1__
...
class TxResponse(betterproto.Message):
    ...
    events: List["____cometbft_abci_v1__.Event"] = betterproto.message_field(13)
    """
...
class Result(betterproto.Message):
    ...
    events: List["____cometbft_abci_v1__.Event"] = betterproto.message_field(3)
    """
...
class SearchBlocksResult(betterproto.Message):
    ...
    blocks: List["____cometbft_types_v1__.Block"] = betterproto.message_field(6)
